...
<head>
  ...
  <title>Company/Institutions</title>
  <!-- plugins:css -->
        ...
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              ...
              <h4>Pending Sponsors (Company/Institution)</h4>
              <div class="row">
                <?php
                        ...
                        ?>
                        <?php
                        $sql = "SELECT * FROM sponsor_t WHERE sponsortype='C'";
                  ...
                  <table id="order-listing" class="table" cellspacing="0">
                    ...
                    <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($result))
                                {
                                  ...
                                  <td>
                                  <a onclick='return confirm('Are you sure?');' class='btn btn-info btn-fw' href='reviewcompany.php?sponsorid={$row['sponsorid']}'>Review Application</a> 
