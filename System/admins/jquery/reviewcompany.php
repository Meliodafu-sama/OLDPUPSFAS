            ...
            <div class="col-lg-4 side-left">
              <div class="row">
                <div class="col-12 grid-margin stretch-card">
                  <div class="card">
                   <form action="reviewcompany.php" method="post">
                      ...
                      <br>
                     <center>
                        <button class="btn btn-success btn-fw" name="accept">Accept</button>
              ...
              <?php 
                ...
                {
                  $sql = "UPDATE sponsor_t SET status='2' WHERE sponsorid=$X";
